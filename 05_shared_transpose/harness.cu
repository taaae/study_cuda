// Exercise 05 harness — DO NOT EDIT.
// Builds data, runs your solve(), checks correctness, runs the exercise-04
// single-sided transpose as the baseline, reports speedup and bandwidth.
#include <vector>
#include <cmath>
#include <cstdio>
...
// --- Baseline: the exercise-04 answer (coalesced reads, STRIDED writes, no
// shared memory). The shared-memory version must beat this. ---
